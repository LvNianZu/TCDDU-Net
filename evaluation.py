...
for name_experiment in name_experiment_list:
    ...
    path_experiment = '/home/lvlv/lv_nian_zu/paper_3/code/my_project/DUNet-retinal-vessel-detection-master/log/experiments/'+algorithm_config + '/' + dataset + '/'
    ...
    if dataset == 'HRF':
        ...
        #/home/lvlv/lv_nian_zu/paper_3/code/my_project/DUNet-retinal-vessel-detection-master/log/experiments/my_unet_Trans/DRIVE/DRIVE_predict_results.h5
        # h5_path =  path_experiment + dataset + '_predict_results.h5'
        h5_path = '/home/lvlv/lv_nian_zu/paper_3/code/my_project/DUNet-retinal-vessel-detection-master/log/experiments/Dense_Transfomer_unet/DRIVE/DRIVE001_predict_results.h5'
        file = h5py.File(h5_path, 'r')
        # file = h5py.File('/home/lvlv/lv_nian_zu/paper_3/code/my_project/DUNet-retinal-vessel-detection-master/log/experiments/my_unet_Trans/DRIVE/DRIVE_predict_results.h5')
        gtruth_masks = file['y_gt'][:]
        pred_imgs = file['y_pred'][:]
        orig_imgs = file['x_origin'][:]
        file.close()
    ...
    # Save the results
    file_perf = open('/home/lvlv/lv_nian_zu/paper_3/code/my_project/DUNet-retinal-vessel-detection-master/log/experiments/'+algorithm_config+'/DRIVE/'+ 'performances_new.txt', 'w')
